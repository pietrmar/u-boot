...
struct nand_flash_dev nand_flash_ids[] = {
	...
	{"TC58NVG1S3 2G 3.3V 8-bit",
		{ .id = {0x98, 0xda, 0x90, 0x15, 0x76, 0x16, 0x8, 0x00} },
	...
	{"TH58NVG4S0FBAID 16G 3.3V 8-bit",
		{ .id = {0x98, 0xd5, 0x91, 0x26, 0x76, 0x15, 0x02, 0x08} },
		  SZ_4K, SZ_2K, SZ_256K, 0, 8, 232, NAND_ECC_INFO(4, SZ_512) },
